...
EXPORTEDFUNCTIONS="['_main', '_OpusCreateEncoder', '_OpusCreateDecoder', '_OpusDestroyEncoder', '_OpusDestroyDecoder', '_OpusGetBitrate', '_OpusSetBitrate', '_OpusEncodeFloat', '_OpusDecodeFloat']"
...
$(OPUSLIBJS): $(OPUSLIB)
	...
	emcc $(OPUSWRAPPER) -I $(OPUSLIBINC) $(EMCCFLAGS) -o $(OPUSLIBJS) -L $(OPUSLIB) -s EXPORTED_FUNCTIONS=$(EXPORTEDFUNCTIONS) -s NO_EXIT_RUNTIME=1 -s PRECISE_I64_MATH=2
