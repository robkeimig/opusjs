...
EXPORTEDFUNCTIONS="['_main', '_OpusEncoderInitVoip', '_OpusEncoderInitAudio', '_OpusEncodeFloat', '_OpusEncode', '_OpusDecoderInit', '_OpusDecode', '_OpusDecodeFloat', '_OpusSetBitrate']"
